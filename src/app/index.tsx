...
export default function HomeScreen() {
    ...
    return (
        // ✅ ScreenWrapper cuida de: StatusBar, Gradient, Glow, SafeArea
            ...
            >
                ...
                <View className="px-5 pt-2 pb-2 flex-row items-center justify-between">
                    ...
                    >
                        <View className="relative">
                            <Image
                                ...
                                className="w-10 h-10 rounded-full border-2 border-ui-border"
                            />
                            <View className="absolute bottom-0 right-0 w-3 h-3 rounded-full bg-brand border-2 border-ui-bg" />
                        </View>
                        <View>
                            <Text className="text-xs text-text-secondary font-medium">Boa noite,</Text>
                            <Text className="text-sm font-bold text-text-primary">Gabriel</Text>
                        </View>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        className="flex-row items-center gap-2 pl-2 pr-3 py-1.5 rounded-full bg-ui-surface border border-ui-border"
                    >
                        ...
                        <View>
                            <Text className="text-[10px] text-text-muted uppercase font-bold tracking-wider">Pontos</Text>
                            <Text className="text-xs font-bold text-text-primary">2.450</Text>
                        </View>
                    </TouchableOpacity>
                </View>
                ...
                <View className="px-5 mt-4">
                    <View className="flex-row items-center h-14 rounded-2xl bg-ui-surface border border-ui-border overflow-hidden">
                        <View className="pl-5">
                        ...
                        <TextInput
                            ...
                            className="flex-1 px-4 text-text-primary text-base"
                            style={{ height: 56 }}
                        />
                        <TouchableOpacity className="w-10 h-10 mr-2 rounded-xl bg-ui-surface items-center justify-center">
                ...
                <View className="mt-10">
                    <View className="px-5 flex-row items-center justify-between mb-4">
                        <View>
                            <Text className="text-xl font-bold text-text-primary">Bairro Favoritos</Text>
                            <Text className="text-xs text-text-muted">O que seus vizinhos estão pedindo</Text>
                        </View>
                        <TouchableOpacity onPress={() => Haptics.selectionAsync()}>
                            <Text className="text-xs font-bold text-brand">Ver todos</Text>
                        </TouchableOpacity>
                    </View>
